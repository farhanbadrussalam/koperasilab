...
@section('content')
                        ...
                        <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-0 rounded-top-4">
                            <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active fw-bold text-primary border-bottom-0" id="detail-tab"
                                        data-bs-toggle="tab" data-bs-target="#detail" type="button">
                                        <i class="bi bi-file-earmark-text me-2"></i>Informasi Layanan
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link text-muted border-bottom-0" id="customer-tab"
                                        data-bs-toggle="tab" data-bs-target="#customer" type="button">
                        ...
                        <div class="card-body p-4">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="detail" role="tabpanel">
                                    ...
                                    <h6 class="text-uppercase text-muted small fw-bold mb-3 tracking-wide">Klasifikasi Jasa
                                    </h6>
                                            ...
                                            <div class="p-3 bg-light rounded-3 border h-100">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h6 class="mb-0 fw-bold text-dark">
                                                        {{ $permohonan->layanan_jasa->nama_layanan }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="p-3 bg-light rounded-3 border h-100">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h6 class="mb-0 fw-bold text-dark">
                                                        {{ $permohonan->jenis_layanan_parent->name }} -
                                                        {{ $permohonan->jenis_layanan->name }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="p-3 bg-light rounded-3 border">
                                                ...
                                                <span
                                                    class="fw-bold text-dark fs-6">{{ $permohonan->jenisTld->name }}</span>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                    ...
                                    <h6 class="text-uppercase text-muted small fw-bold mb-3 tracking-wide">Spesifikasi
                                        Kontrak</h6>
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex mb-3 align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="badge bg-primary-subtle text-primary border border-primary-subtle px-2 py-1 mt-1">
                                        ...
                                        @if ($permohonan->periode_next)
                                            <div class="col-md-6">
                                                <div class="d-flex mb-3 align-items-center">
                                                    <i class="bi bi-calendar-range me-3 text-secondary fs-5"></i>
                                                    <div>
                                                        <small class="text-muted d-block">Periode Pemakaian
                                                            Selanjutnya</small>
                                                        <div class="d-flex gap-1 flex-column">
                                                            <div class="fw-bold text-dark" id="periode-pemakaian-next">-
                                                            </div>
                                                            <div>
                                                                <button class="btn btn-xs btn-link text-decoration-none p-0"
                                                                    id="btn-periode-next">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-bold text-dark fs-5"
                                                        id="jumlah-info-pengguna">0</span>
                                ...
                                <div class="tab-pane fade" id="customer" role="tabpanel">
                                    <div class="row g-4 mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                class="p-3 bg-light rounded-4 border h-100 position-relative overflow-hidden">

                                                <h6 class="text-uppercase text-muted small fw-bold mb-3 tracking-wide">
                                                    <i class="bi bi-person-circle me-1 text-primary"></i>Penanggung Jawab
                                                    (PIC)
                                                </h6>
                                                ...
                                                <div class="d-flex align-items-center mb-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted" id="jabatan-pic">Bagian Umum /
                                                            Staff</small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        <small class="text-muted d-block mb-1"
                                                            style="font-size: 0.75rem;">Nomor WhatsApp / Telepon</small>
                                                        <span class="fw-bold text-dark font-monospace"
                                                            id="telepon-pic">-</span>
                                                    </div>
                                                    <div class="col-12">
                                                        <small class="text-muted d-block mb-1"
                                                            style="font-size: 0.75rem;">Email Pribadi</small>
                                                        <span class="fw-bold text-dark"
                                                            id="email-pic">supri.driver@gmail.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="p-3 bg-white rounded-4 border h-100 shadow-sm">
                                                <div class="d-flex justify-content-between align-items-start mb-3">
                                                    ...
                                                    <span class="badge border border-success-subtle rounded-pill"
                                                        id="status-instansi">
                                                        <i class="bi bi-check-circle-fill me-1"></i>Terverifikasi
                                                    </span>
                                                </div>

                                                <h5 class="fw-bold text-dark mb-3" id="nama-instansi">PT. Rachman Abadi
                                                </h5>
                                                <p class="text-muted small mb-3 d-none">Perusahaan Jasa Konstruksi & Umum
                                                </p>

                                                <div class="row g-2 p-3 bg-light rounded-3 border">
                                                    <div class="col-6 border-end">
                                                        <small class="text-muted d-block mb-1"
                                                            style="font-size: 0.7rem;">Kode Instansi</small>
                                                        <div class="d-flex align-items-center">
                                                            <span class="fw-bold text-dark font-monospace small me-2"
                                                                id="kodeInstansi">-</span>
                                                            <i class="bi bi-copy text-secondary cursor-pointer"
                                                                style="font-size: 0.8rem;" title="Salin"
                                                                onclick="copyKode('kodeInstansi')"></i>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 ps-3">
                                                        <small class="text-muted d-block mb-1"
                                                            style="font-size: 0.7rem;">NPWP Perusahaan</small>
                                                ...
                                                <div class="mt-3">
                                                    <small class="text-muted d-block mb-1"
                                                        style="font-size: 0.75rem;">Email Resmi Instansi</small>
                                                    <a href="#" class="text-decoration-none fw-bold small"
                                                        id="email-perusahaan">contact@rachman.com</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card h-100 border border-primary">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <div class="rounded-circle bg-white p-1 text-secondary me-2 shadow-sm border"
                                                            style="width: 28px; height: 28px; display:grid; place-items:center;">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card h-100 border-0 bg-light">
                                                <div class="card-body p-3">
                                                    ...
                                                    <p class="text-muted small mb-0" id="alamat-invoice">Sama dengan
                                                        alamat utama</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-3">
                        ...
                        <div class="card-body px-4 pb-4">
                            <div></div>
                            <div id="show-tandaterima"
                                class="d-none p-3 bg-white rounded-3 border border-success border-opacity-25 shadow-sm position-relative overflow-hidden transition-all hover-shadow mb-3">
                            ...
                            <div id="tambah-tandaterima"
                                class="border-2 border-dashed border-secondary border-opacity-25 rounded-3 p-4 text-center bg-light mb-3">
                                <i class="bi bi-file-earmark-plus text-muted fs-3 mb-2 d-block"></i>
                                <h6 class="fw-bold text-dark small mb-1">Tanda Terima *</h6>
                                <small class="text-muted d-block mb-3" style="font-size: 0.75rem;">Belum ada
                                    dokumen</small>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-3">
                        <div class="card-header bg-white border-bottom-0 pt-4 px-4 rounded-top-4">
                            <h6 class="fw-bold text-dark m-0">
                                <i class="bi bi-calendar-event me-2"></i>Tanggal Selesai LAB <span
                        ...
                        <div class="card-body px-4 pb-4">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 overflow-hidden me-3">
                                    <input type="text" id="tanggal-selesai" class="form-control"
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary py-2 fw-bold"
                                        onclick="verif_kelengkapan('lengkap', this)">
                                        <i class="bi bi-check me-2"></i>Lengkap
                                    </button>
                                    <button class="btn btn-outline-danger py-2"
                                        onclick="verif_kelengkapan('tidak_lengkap', this)">
    ...
    {{-- Modal select tld --}}
    <div class="modal fade" id="modal-verif-invalid" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modal-select-tld" tabindex="-1" aria-labelledby="modal-select-tldLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="simpanTldPermohonan(this)"
                        id="btnPilihTld">Pilih</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="modal-tandaterima" tabindex="-1" aria-labelledby="modal-tandaterimaLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="simpanTandaTerimaPermohonan(this)"
                        id="btnPilihTandaTerima">Simpan</button>
                </div>
            </div>
        </div>
    </div>
