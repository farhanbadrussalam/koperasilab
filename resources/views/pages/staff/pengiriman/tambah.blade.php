...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="no_resi" id="no_resi" class="form-control"
                                        placeholder="Inputkan no resi">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="" class="form-label">No kontrak/Permohonan</label>
                                    <div class="input-group">
                                        <input type="text" name="no_permohonan" id="no_permohonan"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="file" class="form-control" id="uploadBuktiPengiriman"
    ...
    <div class="modal fade" id="modal-detail-invoice" data-bs-backdrop="static" tabindex="-1"
        aria-labelledby="modal-detail-invoiceLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-4">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="cetakDocument()"><i
                            class="bi bi-printer-fill"></i> Cetak Kwitansi</button>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script src="{{ asset_versioned('js/staff/pengiriman_tambah.js') }}"></script>
@endpush
