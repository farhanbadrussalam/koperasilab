...
@section('content')
    ...
    <div class="modal fade" id="modal-buat-pengiriman" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modal-detail-pengiriman" tabindex="-1" aria-labelledby="detailModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal-kirim-dokumen" tabindex="-1" aria-labelledby="kirimDokumenModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-secondary-subtle" id="no_pengiriman"
                            name="no_pengiriman" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="jasa_kurir" class="form-label">Jasa Kurir<span
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Upload bukti pengiriman<span
                                class="text-danger ms-1">*</span></label>
                ...
                <div class="modal-footer border-0 p-2 d-flex justify-content-between gap-2">
                    ...
                    <button type="submit" form="formKirimDokumen" id="btn-kirim"
                        class="btn btn-primary rounded-3 flex-grow-1" onclick="kirimDokumen(this)">Kirim</button>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script src="{{ asset_versioned('js/staff/pengiriman.js') }}"></script>
@endpush
