...
@section('content')
    ...
    <div class="modal fade" id="modalEditPerusahaan" tabindex="-1" aria-labelledby="modalEditPerusahaanLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-end">
                        <button class="btn btn-primary" onclick="simpanEditPerusahaan()"
                            id="simpanEditPerusahaan">Simpan</button>
                    </div>
                </div>
            </div>
        </div>
...
@endsection
@push('scripts')
    <script src="{{ asset_versioned('js/staff/perusahaan.js') }}"></script>
@endpush
