                    ...
                    <form action="{{ route('jadwal.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label for="selectLayananjasa" class="col-md-3 form-label">Layanan</label>
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="selectJenisLayanan" class="form-label">Jenis Layanan</label>
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="inputDateMulai" class="form-label">Tanggal mulai</label>
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="inputDateSelesai" class="form-label">Tanggal selesai</label>
                            ...
                            <div class="col-md-12 mb-2">
                                <label for="uploadFile" class="form-label">Upload Dokumen</label>
                                <input type="file" accept=".pdf,.doc,.docx" name="dokumen" id="uploadFile" class="form-control @error('dokumen')
                                    is-invalid
                                @enderror">
                                @error('dokumen')
                                    <div class="invalid-feedback">
