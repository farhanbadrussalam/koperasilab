        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label for="txt_date_diterima" class="form-label small fw-bold text-muted text-uppercase mb-2">Tanggal Diterima</label>
                        <div class="input-group shadow-sm rounded-3">
                            <span class="input-group-text bg-white border-end-0 text-muted"><i class="bi bi-calendar-event"></i></span>
                            <input type="text" class="form-control border-start-0 ps-0" name="txt_date_diterima" id="txt_date_diterima">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card border border-info-subtle bg-info-subtle bg-opacity-10 rounded-3 mb-2 shadow-xs">
                            <div class="card-body p-2 d-flex justify-content-between align-items-center">
                                ...
                                <button class="btn btn-link btn-sm text-decoration-none fw-bold text-info p-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBuktiPengiriman" aria-expanded="false" aria-controls="collapseBuktiPengiriman">
                    ...
                    <div class="col-12 mt-2">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-2">Kelengkapan Dokumen <span class="text-danger">*</span></label>
                    ...
                    <div class="col-12 mt-2">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-2">Upload Bukti Penerima <span class="text-danger">*</span></label>
