    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Ganti PIC</h1>
                ...
                <form id="form-pic" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" class="form-control maskNIK" id="input-nik-pic" name="nik"
                                placeholder="" autocomplete="true" required minlength="16"
                        ...
                        <div class="col-md-6 mb-2">
                            <label for="email" class="form-label">Email <span
                                    class="fw-bold fs-14 text-danger">*</span></label>
                            <input type="email" class="form-control maskEmail" id="input-email-pic" name="email"
                                autocomplete="true" required data-parsley-required-message="Email harus diisi"
                                data-parsley-errors-container="#email_error">
                            <div id="email_error" class="invalid-feedback d-block"></div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="nama_pic" class="form-label">Nama <span
                                    class="fw-bold fs-14 text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama_pic-pic" name="nama_pic" required
                                data-parsley-required-message="Nama harus diisi">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="jabatan_pic" class="form-label">Jabatan</label>
                            <input type="text" class="form-control" id="jabatan_pic-pic" name="jabatan_pic"
                                placeholder="" value="">
                        </div>
                        <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" class="form-control maskTelepon" id="telepon-pic" name="telepon"
                                required data-parsley-required-message="Telepon harus diisi">
                        </div>
                        <div class="mb-3">
                            <label for="alamat" class="form-label">Alamat <span
                                    class="fw-bold fs-14 text-danger">*</span></label>
                            <textarea name="alamat" id="alamat-pic" cols="30" rows="5" class="form-control" required
                                data-parsley-required-message="Alamat harus diisi"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="uploadSuratKuasa-pic" class="form-label">Surat Kuasa <span
                                    class="fw-bold fs-14 text-danger">*</span></label>
                            <div id="uploadSuratKuasa-pic"></div>
                        </div>
                        @role('Pelanggan')
                            <div class="col-md-6 mb-2">
                                <label for="input-password-pic" class="form-label">Password <span
                                        class="fw-bold fs-14 text-danger">*</span></label>
                                <div class="input-group mb-2 mt-1">
                                    <input type="password" class="form-control" id="input-password-pic" name="password"
                                        required data-parsley-required-message="Password harus diisi"
                                        data-parsley-trigger="input" data-parsley-minlength="8"
                                        data-parsley-lowercase="true" data-parsley-uppercase="true"
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="password_confirmation-pic" class="form-label">Konfirmasi Password <span
                                        class="fw-bold fs-14 text-danger">*</span></label>
                                <div class="input-group mb-2 mt-1">
                                    <input type="password" class="form-control" id="password_confirmation-pic"
                                    ...
                                    <div class="input-group-text border-0 rounded-end bg-body-secondary"
...
<script src="{{ asset_versioned('js/profile/modal_pic.js') }}"></script>
