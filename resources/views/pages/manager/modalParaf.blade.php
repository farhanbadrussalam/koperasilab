                ...
                <div class="d-flex justify-content-between m-2 mt-4">
                    ...
                    <div class="row w-50">
                        <div class="wrapper" id="content-ttd">
                            ...
                            <canvas id="signature-lhu" class="signature-pad border border-success-subtle rounded border-1" width=200 height=110></canvas>
                ...
                <div class="d-flex justify-content-center m-2">
                    ...
                    <div class="row">
                        <div class="wrapper" id="content-ttd-invoice">
                            ...
                            <canvas id="signature-kip" class="signature-pad border border-success-subtle rounded border-1" width=200 height=110></canvas>
                            <p class="text-center">Manager</p>
                        </div>
