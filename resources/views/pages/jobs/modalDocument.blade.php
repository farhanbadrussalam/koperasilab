    ...
    <script>
        function detailkiplhu(id) {
            ajaxGet(`api/permohonan/show/${id}`, false, result => {
                ...
                const dataLhu = data.jadwal.tbl_lhu;
                ...
                for (const jawaban of dataLhu.jawaban) {
                    let contentJwb = createPertanyaan(jawaban);
                    contentPertanyaan.appendChild(contentJwb);
                }
                $('#ttd_penyelialab').attr('src', dataLhu.ttd_2);
                $('#ttd_manager').attr('src', dataLhu.ttd_3);
        ...
        function sendDocumen(){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    ajaxPost(`api/lhu/sendToPelanggan`, formData, result => {
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: result.message
        ...
        function createPertanyaan(list){
            ...
            mainDiv.className = 'col-md-12 mb-2'
