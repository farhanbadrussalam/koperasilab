                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" name="kuota" id="inputKuota" class="form-control @error('kuota')
                                is-invalid
                            @enderror" value="{{ old('kuota') ? old('kuota') : $jadwal->kuota }}" readonly>
                            @error('kuota')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" name="tanggal_mulai" id="inputDateMulai" class="form-control" value="{{ old('tanggal_mulai') ? old('tanggal_mulai') : $jadwal->date_mulai }}" readonly>
                            @error('tanggal_mulai')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" name="tanggal_selesai" id="inputDateSelesai" class="form-control" value="{{ old('tanggal_selesai') ? old('tanggal_selesai') : $jadwal->date_selesai }}" readonly>
