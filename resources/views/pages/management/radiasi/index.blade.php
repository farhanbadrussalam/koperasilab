            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0">Kelola daftar jenis/sumber radiasi yang didata untuk pengawasan TLD
                            di sistem.</p>
                    </div>
                </div>
                <button
                    class="btn btn-primary px-4 py-2 rounded-pill shadow-sm d-flex align-items-center gap-2 hover-scale transition-all"
                    data-bs-toggle="modal" data-bs-target="#createRadiasiModal">
...
@push('scripts')
    <script src="{{ asset_versioned('js/management/radiasi.js') }}"></script>
@endpush
