        ...
        <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 fw-bold text-dark">Jenis Radiasi</h4>
                        <p class="text-muted small mb-0">Kelola daftar jenis/sumber radiasi yang didata untuk pengawasan TLD di sistem.</p>
                    </div>
                </div>
                <button class="btn btn-primary px-4 py-2 rounded-pill shadow-sm d-flex align-items-center gap-2 hover-scale transition-all" data-bs-toggle="modal" data-bs-target="#createRadiasiModal">
                    <i class="bi bi-plus-lg"></i>
                    <span>Tambah Radiasi</span>
                </button>
            </div>
        </div>
        <div class="card-body px-4 pb-4 pt-3">
            ...
            <div class="row mt-2">
                <div class="overflow-y-auto">
                    <table class="table table-hover w-100 align-middle table-borderless border-bottom" id="radiasi-table">
                        <thead class="table-light">
                            <th width="8%" class="text-center py-3">No</th>
                            <th class="py-3">Nama Radiasi</th>
