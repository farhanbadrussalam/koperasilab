            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ isset($d_user) ? 'Update' : 'Create' }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-default color-palette-box shadow">
                <div class="card-header d-flex ">
                    <h2 class="card-title flex-grow-1">
                        {{ isset($d_user) ? 'Update Users' : 'Create Users' }}
                    </h2>
                </div>
                <div class="card-body">
                    <form action="{{ isset($d_user) ? route('users.update', encryptor($d_user->id)) : route('users.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @if(isset($d_user))
                            @method('PUT')
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="inputFullname" value="{{ old('name', $d_user->name ?? '') }}">
                                @error('name')
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="nik" id="inputNik" class="form-control maskNIK @error('nik') is-invalid @enderror" value="{{ old('nik', $d_user->profile->nik ?? '') }}">
                                @error('nik')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="no_telepon" id="inputNoHp" class="form-control maskTelepon @error('no_telepon') is-invalid @enderror" value="{{ old('no_telepon', $d_user->profile->no_hp ?? '') }}">
                                @error('no_telepon')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="jenis_kelamin" id="inputJenisKelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror">
                            ...
                            <div class="col-md-12 mb-2 d-none" id="tugas_lhu">
                                <label for="inputTugasLhu" class="form-label">Tugas LHU</label>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="email" name="email" id="inputEmail" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $d_user->email ?? '') }}">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea name="alamat" id="inputAlamat" cols="30" rows="3" class="form-control">{{ old('alamat', $d_user->profile->alamat ?? '') }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12 mt-3 text-center {{ isset($d_user) ? 'd-flex justify-content-between' : '' }}">
                                @if(isset($d_user))
                                    <button type="button" class="btn btn-danger" onclick="deleteUser()">Delete User</button>
                                @endif
                                <button type="submit" class="btn btn-primary">{{ isset($d_user) ? 'Update' : 'Simpan' }}</button>
                            </div>
                        </div>
                    </form>
                </div>
