            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0">Kelola dan batasi hak akses sistem secara granular berdasarkan peran pengguna.</p>
                    </div>
                </div>
                <button class="btn btn-primary px-4 py-2 rounded-pill shadow-sm d-flex align-items-center gap-2 hover-scale transition-all" data-bs-toggle="modal" data-bs-target="#create_modal">
        ...
        <div class="card-body px-4 pb-4 pt-3">
            ...
            <div class="row mt-2">
                <div class="overflow-y-auto">
                    <table class="table table-hover w-100 align-middle table-borderless border-bottom" id="permission-table">
