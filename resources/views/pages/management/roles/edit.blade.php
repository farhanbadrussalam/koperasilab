        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form id="form-edit" method="post" data-parsley-validate>
                ...
                <div class="modal-body px-4 pt-3 pb-2">
                    <div class="mb-3">
                        <label for="inputEditNameRole" class="form-label fw-semibold text-secondary">Name Role <span class="text-danger">*</span></label>
                        <input type="text" 
                               name="name" 
                               id="inputEditNameRole" 
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted small mt-n1 mb-3">Sesuaikan hak akses yang dimiliki oleh peran ini. Pilih berdasarkan kategori di bawah.</p>
                        ...
                        <div class="accordion" id="accordionPermissionsEdit">
                            @foreach ($groupedPermissions as $category => $items)
                                ...
                                <div class="accordion-item border border-light-subtle rounded-3 mb-2 overflow-hidden">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button bg-light-subtle fw-semibold text-dark py-3 px-3 d-flex align-items-center justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCatEdit{{ $catSlug }}" aria-expanded="true">
                                    ...
                                    <div id="collapseCatEdit{{ $catSlug }}" class="accordion-collapse collapse show" data-bs-parent="#accordionPermissionsEdit">
                                                ...
                                                @foreach ($items as $permission)
                                                    <div class="col">
                                                        <div class="form-check form-switch p-3 rounded border border-light-subtle bg-light-subtle hover-bg transition-all h-100 d-flex align-items-center">
                                                            ...
                                                            <label class="form-check-label cursor-pointer text-dark fw-medium small mb-0 w-100" for="checkPermission{{ $permission->id }}">
                                                                {{ $permission->name }}
                                                            </label>
                                                        </div>
                                                    </div>
