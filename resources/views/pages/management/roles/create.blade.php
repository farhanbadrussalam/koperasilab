        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form id="form-create" method="post" data-parsley-validate>
                ...
                <div class="modal-body px-4 pt-3 pb-2">
                    <div class="mb-3">
                        <label for="inputNameRole" class="form-label fw-semibold text-secondary">Name Role <span
                                class="text-danger">*</span></label>
                        <input type="text" name="name" id="inputNameRole" class="form-control rounded-3"
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold text-secondary d-block">Permissions <span
                                class="text-danger">*</span></label>
                        <p class="text-muted small mt-n1 mb-3">Tentukan hak akses apa saja yang dimiliki oleh peran ini.
                            Pilih berdasarkan kategori di bawah.</p>
                        ...
                        <div class="accordion overflow-auto" id="accordionPermissionsCreate" style="max-height: 300px;">
                                ...
                                <div class="accordion-item border border-light-subtle rounded-3 mb-2 overflow-hidden">
                                    <h2 class="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#collapseCatCreate{{ $catSlug }}" aria-expanded="true">
                                    ...
                                    <div id="collapseCatCreate{{ $catSlug }}"
                                        class="accordion-collapse collapse show"
                                        data-bs-parent="#accordionPermissionsCreate">
                                                    ...
                                                    <div class="col">
                                                        <div
                                                            ...
                                                            <label
                                                                ...
                                                                for="createPermission{{ $permission->id }}">
                                                                {{ $permission->name }}
                                                            </label>
                                                        </div>
                                                    </div>
