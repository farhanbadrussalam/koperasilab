            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0">Kelola database fisik dosimeter TLD (kontrol/pengguna), kepemilikan,
                            serta status penggunaannya.</p>
                    </div>
                </div>
                <button
...
@endsection
@push('scripts')
    <script src="{{ asset_versioned('js/management/tld.js') }}"></script>
@endpush
