            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div class="d-flex align-items-center">
                    <div class="icon-box bg-primary-subtle text-primary rounded-circle p-2 me-3 d-flex align-items-center justify-content-center" style="width: 45px; height: 45px;">
                        <i class="bi bi-device-ssd-fill fs-5"></i>
                    </div>
                    <div>
                        <h4 class="mb-0 fw-bold text-dark">Master TLD</h4>
                        <p class="text-muted small mb-0">Kelola database fisik dosimeter TLD (kontrol/pengguna), kepemilikan, serta status penggunaannya.</p>
                    </div>
                </div>
                <button class="btn btn-primary px-4 py-2 rounded-pill shadow-sm d-flex align-items-center gap-2 hover-scale transition-all" id="btn-create-tld">
        ...
        <div class="card-body px-4 pb-4 pt-3">
            ...
            <div class="row mt-2">
                <div class="overflow-y-auto">
                    <table class="table table-hover w-100 align-middle table-borderless border-bottom" id="tld-table">
                        <thead class="table-light">
                            <th width="8%" class="text-center py-3">No</th>
                            <th class="py-3">No Seri TLD</th>
                            <th class="py-3" width="20%">Jenis</th>
