        ...
        <ul class="navbar-nav flex-row ms-0 align-items-center justify-content-end">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ Auth::user()->profile->media ? asset('storage/images/avatar/'. Auth::user()->profile->media->file_hash) : asset('images/profile/user-1.jpg')}}" alt="" width="35" height="35" class="rounded-circle">
                </a>
