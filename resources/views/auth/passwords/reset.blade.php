                ...
                <div class="d-flex justify-content-center align-items-center flex-fill">
                    <div class="text-center border rounded-4 shadow p-4"
                        ...
                        <div class="alert alert-light border-start border-4 border-info shadow-sm mb-4 text-start">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted" style="font-size: 0.8rem;">Gunakan kombinasi huruf besar,
                                        kecil, dan angka agar password sulit ditebak.</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.update') }}" id="form-reset-password" novalidate>
                            ...
                            <div class="mb-3 text-start">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="email" type="email"
                                        class="form-control px-3 @error('email') is-invalid @enderror" name="email"
                                        value="{{ $email ?? old('email') }}" placeholder="E-mail" required
                            ...
                            <div class="mb-3 text-start">
                                <label class="form-label small fw-bold text-muted">Password Baru <span
                                        class="fw-bold fs-14 text-danger">*</span></label>
                                <div class="input-group">
                                    <input
                                        class="form-control form-control input-login @error('password') is-invalid @enderror"
                                        id="password" type="password" name="password" required data-parsley-trigger="input"
                                        data-parsley-minlength="8" data-parsley-lowercase="true"
                                        data-parsley-uppercase="true" data-parsley-errors-container="#error-new-password"
                                        placeholder="Enter your new password" />
                                    <button type="button" class="input-group-text btn border-start-0 border"
                                        onclick="showPasswordInput(this, 'password')">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                </div>
                                <div class="progress mt-2" style="height: 4px;">
                                    <div class="progress-bar bg-danger" id="strengthBar" role="progressbar"
                                        style="width: 0%"></div>
                                </div>
                                <ul id="password-rules" class="p-3 bg-light rounded-3 mt-2 text-start"
                                    style="font-size: 0.85rem; list-style-type: none;">
                                </ul>
                            ...
                            <div class="mb-4 text-start">
                                <label class="form-label small fw-bold text-muted">Konfirmasi Password <span
                                        class="fw-bold fs-14 text-danger">*</span></label>
                                <div class="input-group">
                                    <input class="form-control form-control input-login" id="password-confirm"
                                        type="password" name="password_confirmation" required data-parsley-trigger="input"
                                    ...
                                    <button type="button" class="input-group-text btn border-start-0 border"
                                        onclick="showPasswordInput(this, 'password-confirm')">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                </div>
