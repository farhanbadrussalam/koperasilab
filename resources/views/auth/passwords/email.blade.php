        ...
        <div class="d-flex flex-column vh-100">
            <div class="d-flex justify-content-center align-items-center flex-fill">
                <div class="text-center border rounded-4 shadow p-4" style="width: 100%; max-width: 420px; background-color: #ffffff;">
                    ...
                    <div class="text-grey mb-4">Lupa Kata Sandi? Masukkan email Anda untuk menerima link pemulihan.</div>
                    ...
                    <form action="{{ route('password.email') }}" method="post">
                        ...
                        <div class="text-center">
                            <a href="{{ route('login') }}" class="text-decoration-none" style="color: #0d6efd; font-size: 14px; font-weight: 500;">Kembali ke Halaman Masuk</a>
                        </div>
                    </form>
                </div>
            </div>
