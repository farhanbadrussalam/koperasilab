                            ...
                            <div class="col-md-10">
                                <div>
                                    ...
                                    <div class="input-group input-group-lg shadow-sm rounded">
                                        <input type="text" class="form-control maskNIK" placeholder="Contoh: 3201..." autocomplete="false" id="input-cek-akun"
                                            required
                                            data-parsley-minlength-message="NIK minimal 16 karakter"
                                            data-parsley-errors-container="#message-input-nik"
                                            minlength="16">
                                        <button type="button" class="btn btn-primary px-4" onclick="searchAkun(this)" id="btn-cek-akun">Cari</button>
                                    </div>
                        ...
                        <form action="{{ route('register') }}" method="post" enctype="multipart/form-data" id="form-registration">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="row g-3 px-md-4">
                                    <div class="col-md-6">
                                        <label for="nik" class="form-label small fw-bold text-uppercase text-muted">NIK <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control bg-light" id="input-nik" name="nik" readonly>
                                            <button type="button" class="btn btn-outline-secondary btn-sm" onclick="changeNik()">Ganti</button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="email" class="form-label small fw-bold text-uppercase text-muted">Email <span class="text-danger">*</span></label>
                                        <input type="email" class="form-control maskEmail" id="input-email" name="email" required
                                    ...
                                    <div class="col-md-6">
                                        <label for="nama_pic" class="form-label small fw-bold text-uppercase text-muted">Nama Lengkap <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="nama_pic" name="nama_pic" required data-parsley-required-message="Nama harus diisi">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="jabatan_pic" class="form-label small fw-bold text-uppercase text-muted">Jabatan</label>
                                        <input type="text" class="form-control {{ $errors->has('jabatan_pic') ? 'is-invalid' : '' }}" id="jabatan_pic" name="jabatan_pic" value="{{ old('jabatan_pic') }}">
                                        @error('jabatan_pic')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        <label for="jenis_kelamin" class="form-label small fw-bold text-uppercase text-muted">Jenis Kelamin <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="telepon" class="form-label small fw-bold text-uppercase text-muted">Telepon <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-12">
                                        <label for="alamat" class="form-label small fw-bold text-uppercase text-muted">Alamat Domisili <span class="text-danger">*</span></label>
                                        <textarea name="alamat" id="alamat" rows="2" class="form-control" required data-parsley-required-message="Alamat harus diisi"></textarea>
                                    </div>
                                    <div class="col-12 text-center mt-3">
                                        <label class="form-label small fw-bold text-uppercase text-muted d-block mb-3">Foto Profil (Avatar)</label>
                                        <div class="profile-avatar-container">
                                            <img src="{{ asset('assets/img/default-avatar.jpg') }}"
                                                id="avatar-preview"
                                                alt="Avatar Preview"
                                                class="profile-avatar-preview">
                                            <label for="avatar" class="profile-avatar-upload-btn" title="Pilih Foto">
                                    ...
                                    <div class="col-md-6">
                                        <label for="password" class="form-label small fw-bold text-uppercase text-muted">Password <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                        ...
                                        <ul id="password-rules" class="mt-2 small text-muted ps-0" style="list-style: none;"></ul>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="password_confirmation" class="form-label small fw-bold text-uppercase text-muted">Konfirmasi Password <span class="text-danger">*</span></label>
                                        <div class="input-group">
                            ...
                            <div class="px-md-4 text-center">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                    ...
                                    <button class="btn btn-primary px-5 py-2 rounded-pill shadow-sm" onclick="simpan()" type="button">
