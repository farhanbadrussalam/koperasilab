    ...
    <script>
        class ModalPeriodeKontrak {
            ...
            htmlPeriode(data, kontrak, cekStatusPeriode, arrFind, isModal = false) {
                ...
                const { htmlDoc, statusKirimTld, statusKirimTldNext } = this._generateDocumentHtml(data, kontrak, cekStatusPeriode, aktifDokumenKirim);
                const { htmlAction, htmlInformasi } = this._generateActionAndInfoHtml(data, kontrak, aktifDokumenKirim, statusKirimTld, statusKirimTldNext, isComplete);
            ...
            _generateDocumentHtml(data, kontrak, cekStatusPeriode, aktifDokumenKirim) {
                ...
                return { htmlDoc, statusKirimTld, statusKirimTldNext };
            }
            ...
            _generateActionAndInfoHtml(data, kontrak, aktifDokumenKirim, statusKirimTld, statusKirimTldNext, isComplete) {
                ...
                return { htmlAction, htmlInformasi };
            }
        }
    </script>
@endpush
